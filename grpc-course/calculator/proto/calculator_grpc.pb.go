...
type CalcServiceClient interface {
	Sqrt(ctx context.Context, in *CalcRequest, opts ...grpc.CallOption) (*CalcResponse, error)
}
...
func (c *calcServiceClient) Sqrt(ctx context.Context, in *CalcRequest, opts ...grpc.CallOption) (*CalcResponse, error) {
...
type CalcServiceServer interface {
	Sqrt(context.Context, *CalcRequest) (*CalcResponse, error)
...
func (UnimplementedCalcServiceServer) Sqrt(context.Context, *CalcRequest) (*CalcResponse, error) {
...
func _CalcService_Sqrt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalcServiceServer).Sqrt(ctx, req.(*CalcRequest))
	}
